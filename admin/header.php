  ...
  <ul class="d-flex align-items-center">
    ...
    <li class="nav-item dropdown pe-3">
      ...
      <?php
          ...
          include 'conn.php'; 
          $q="select * from admins where admin_id=".$ro['admin_id']; 
      ...
      ?>
        ...
        <span class="d-none d-md-block dropdown-toggle ps-2">
            <?php
            include 'conn.php'; 
            $q="select * from admins where admin_id=".$row['admin_id']; 
            $res=mysqli_query($conn,$q);
            $row=mysqli_fetch_array($res);

             $name=$row['admin_name'];  //  change here
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
        ...
        <li>
          <a class="dropdown-item d-flex align-items-center" href="login.php">   <!--   chang is here -->
