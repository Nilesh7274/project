              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter Admin Id & password to login</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" action="login.php" method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="number" name="admin_id" class="form-control" id="yourUsername" required>
                    ...
                    <div class="col-12">
                     <button class="btn btn-dark w-100" ><a href="../login.php">Login As Student</a></button>
                    </div>
  ...
  $query=mysqli_query($conn,$id_search);
   ...
   if($id_count)
   {
     ...
     //$pass_decode = password_verify($password,$db_pass);
        ...
        if($password==$db_pass)
        {
          $_SESSION['admin'] = $id_pass;  // change here
            ?>
