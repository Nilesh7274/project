...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/cloud.png" rel="icon">
  <link href="assets/img/cloud.png" rel="apple-touch-icon">
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter your Rollno & password to login</p>
                  </div>

                  <form class="row g-3 needs-validation" action="login.php" method="POST">

                    <div class="col-12">
                      <label for="yourUsername" class="form-label">RollNo</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">*</span>
                        <input type="number" name="rollno" class="form-control" id="yourUsername" required>
                        <div class="invalid-feedback">Please enter your rollno.</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                     <button class="btn btn-dark w-100" name="submit">Login</button>
                    </div>
                      
                    <div class="col-12">
                     <button class="btn btn-dark w-100" ><a href="admin/login.php">Login As Admin</a></button>
                    </div>
              ...
              <div class="credits">
                ...
                Designed by <a href="">CloudClass Team</a>
              </div>
